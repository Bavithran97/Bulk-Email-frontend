...
const User = () => {
    ...
    //
    useEffect(()=>{
        axios.get('https://bulk-email-8uhv.onrender.com/getUser')
    ...
    const formik = useFormik({
        ...
        onSubmit:(values,{resetForm})=>{
            ...
            console.log(firstName,key);
             axios.post('https://bulk-email-8uhv.onrender.com/register',{firstName,lastName,email,key})
  ...
  return (
    <div className='initial' >
        ...
        <span className="material-symbols-outlined maill">
            ...
            <div className='color'> 
                <span className='bulk q'>Bulk</span>
                <span className='emaill q'>Email</span>
                <span className='app q'>App</span>
            </div>
            </div>}
        </div>
