...
const ViewMail = () => {
    ...
    useEffect(()=>{
        axios.get('https://bulk-email-8uhv.onrender.com/getmail/'+id)
        .then(result =>
        {
    ...
    function handleDelete(id){
        ...
        if(window.confirm('You want to delete the mail')){
         ...
         axios.delete('https://bulk-email-8uhv.onrender.com/deletemail/'+id)
        ...
        <div className='viewmail'>
             {/* {console.log(Files)
                    ...
                    <ul className='view1'>
                        ...
                        <div className="imgContainer">
                        {
                            Files != undefined ?Files.map(data=>
                                <div className='positionimg' onClick={()=>viewImage(data)}>
                                         <img className='sendImage' src={'https://bulk-email-8uhv.onrender.com/images/'+data} alt="images"  />
                                </div>
                                ):null
                        }
                        </div>
                        ...
                        {view?
                        <img className='openView' src={'https://bulk-email-8uhv.onrender.com/images/'+view}  alt="" />
                        :null}
